...
image: "./_media/pebble-index-01-review/ring-out-and-about-opt.jpg"
---

This is my review of the Index 01 after a month of usage.

![The Index 01 ring on a hand out and about, held up in front of a Pebble watch with the Thames and boats in the background](./_media/pebble-index-01-review/ring-out-and-about-opt.jpg)
...
![The Index 01 ring resting on a wooden table](./_media/pebble-index-01-review/ring-on-table-opt.webp)
...
_Edit: this was the case until there was an error in the app I found just after writing this, however the Core Devices team are pushing a [hotfix](https://github.com/coredevices/mobileapp/issues/433)!_

![The Hold & Talk settings screen in the Pebble app, with the hold gesture set to run the MCP sandbox against a custom "wiki" sandbox group](./_media/pebble-index-01-review/mcp-config-opt.webp)

![A conversation showing a held recording being transcribed into "Remind me to pick up Alice's parcel from near the one way system tomorrow" and noted straight to a Todo/Inbox list](./_media/pebble-index-01-review/mcp-handoff-example-opt.webp)
...
![A stack of "No audio detected" notifications from Pebble, logged a few minutes apart from accidental clicks while playing guitar](./_media/pebble-index-01-review/false-clicks-notifications-opt.webp)
...
![A close-up of a thumb about to click the Index 01 ring worn on another finger](./_media/pebble-index-01-review/thumb-about-to-click-opt.webp)
