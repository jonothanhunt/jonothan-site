...
excerpt: "",
type: ["SITE"],
image: "/blog-content/audio-nodes/images/audio-nodes.png",
links: [
    { title: "SITE", url: "https://audio-nodes.jonothan.dev" },
...
![Audio Nodes screenshot](/blog-content/audio-nodes/images/audio-nodes.png)
...
![TikTok Effect House screenshot from live stream](/blog-content/audio-nodes/images/effect-house-tutorial.png)
...
![Unity shader graph](/blog-content/audio-nodes/images/unity-shader-graph.jpg)
...
![Audio Nodes screenshot](/blog-content/audio-nodes/images/audio-nodes-blended-wires.png)
