...
![Audio Nodes screenshot](./_media/audio-nodes/audio-nodes.png)
...
![Unity shader graph](./_media/audio-nodes/unity-shader-graph.jpg)
...
![Audio Nodes screenshot](./_media/audio-nodes/audio-nodes-blended-wires.png)
