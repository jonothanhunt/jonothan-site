...
date: 2025-09-08
excerpt: "A node-based app for making audio — my favourite way to work, and an excuse to finally learn Rust and WebAssembly."
type:
  - "Audio"
image: "./_media/audio-nodes/audio-nodes.png"
links:
  - title: "SITE"
    url: "https://audio-nodes.jonothan.dev"
  - title: "GitHub"
    url: "https://github.com/jonothanhunt/audio-nodes"
---

This is [Audio Nodes](https://audio-nodes.jonothan.dev)!

![The Audio Nodes editor: Sequencer, Transpose, Synth, Reverb and Speaker nodes wired together on a dark canvas, with a step grid spelling AN and a searchable list of node types down the left](./_media/audio-nodes/audio-nodes.png)
...
![TikTok Effect House screenshot from live stream](./_media/audio-nodes/effect-house-tutorial.png)
...
![A Unity shader graph of linked noise and gradient nodes building a terrain material, beside the running game: a neon wireframe landscape under a magenta sky](./_media/audio-nodes/unity-shader-graph.jpg)
...
![A close-up of one patch cable, its colour blending along its length from the orange of a MIDI Out socket to the purple of a Synth node's MIDI In](./_media/audio-nodes/audio-nodes-blended-wires.png)
