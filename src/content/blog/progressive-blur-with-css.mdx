export const metadata = {
  ...
  type: ["Post", "SITE", "Code"],
  image: "/blog-content/progressive-blur-with-css/images/progressive_blur_example.jpeg",
};
...
<SandpackEmbed
  basePath="/blog-content/progressive-blur-with-css/code/progressive-blur-comparison/"
...
![image render of progressive backdrop blur on the left and a simpler blur with mask over the top](/blog-content/progressive-blur-with-css/images/progressive_blur_example.jpeg)
...
<SandpackEmbed
  basePath="/blog-content/progressive-blur-with-css/code/progressive-blur-simple/"
  files={[{file: "index.html"}, {file: "styles.css", visible: false}]}
  template="static"
/>
...
<SandpackEmbed
  basePath="/blog-content/progressive-blur-with-css/code/progressive-blur-demo/"
  files={[{file: "index.html"}, {file: "styles.css", visible: false}]}
  template="static"
/>
