...
export const metadata = {
  ...
  type: ["SITE", "AI"],
  image: "/blog-content/thinking-frameworks-and-AI/images/site-screenshot.jpg",
  links: [
    { title: "SITE", url: "https://think.jonothan.dev" }
  ]
};
...
![Screenshot of the site showing the idea I put in and available frameworks. The idea is: A mobile app that helps people overcome social anxiety by gamifying real-world social interactions with achievement badges and progress tracking.](/blog-content/thinking-frameworks-and-AI/images/site-screenshot.jpg)
