...
date: 2026-06-23
excerpt: "My review of the Pebble Time 2, coming from an Apple Watch and a Pixel Watch: two weeks of battery, e-paper and open source."
image: "./_media/pebble-time-2/pebble-time-2-opt.webp"
---
...
![A photo of Jonothan sitting outdoors on a sunny day wearing a Pebble Time 2 on one wrist and a Fitbit on the other](./_media/pebble-time-2/hero-opt.webp)
...
![A screenshot of a detailed battery stats app for the Pebble showing 60% remaining with a projected 14.7 days of full charge life, along with a pie chart breaking down power consumption by backlight, system, and watchface.](./_media/pebble-time-2/pebble-battery-opt.webp)
...
![A screenshot showing Pebble's sleep data inside Google Health, showing very basic tracking of only light and deep sleep stages.](./_media/pebble-time-2/sleep-data-from-pebble-opt.webp)
_This is data from a night where Pebble tracked my sleep. It missed me waking up for a while during that night._

![A screenshot of Fitbit's sleep tracking in Google Health, showing detailed sleep stages including REM, light, deep, and awake times, along with restlessness data.](./_media/pebble-time-2/sleep-data-from-fitbit-opt.webp)
...
![A laptop screen displaying a custom web app named Mesh with a clean design, a greeting, and a prompt box for Gemini 2.5 Flash.](./_media/pebble-time-2/my-other-platforms-opt.webp)
...
![A desk setup featuring a Framework laptop on a wooden stand displaying a Pebble watchface emulator and code editor, flanked by two black speakers and a mechanical keyboard](./_media/pebble-time-2/creating-watchface-opt.webp)

![My custom watchface on the Pebble Time 2](./_media/pebble-time-2/pebble-time-2-opt.webp)
...
![A digital rendering of the Pebble Timeline UI showing an upcoming meeting](./_media/pebble-time-2/pebble-timeline-example-opt.webp)
...
![A screenshot of the Pebble app showing a grid of various custom watchfaces in the Top Picks section](./_media/pebble-time-2/pebble-store-opt.webp)
...
![A screenshot of the World Cup 2026 app for Pebble showing a match and an interactive touch slider](./_media/pebble-time-2/world-cup-app-opt.webp)
