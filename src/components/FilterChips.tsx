...
{availableTypes.map((type, idx) => {
        ...
        return (
          <button
            ...
            className={`px-2.5 py-1 rounded-full text-xs font-medium transition-all duration-300 border cursor-pointer ${isSelected
      ...
      {hasFilters && (
        <button
          ...
          className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-red-100 text-red-900 border border-red-200 text-xs font-medium shadow-sm hover:bg-red-200 transition-all duration-300 cursor-pointer"
        >
          <svg
            width="14"
            height="14"
