...
function TransformGroup(props)
{
  ...
  return (
    <>
      ...
      <Center onCentered={({ container, height, width }) => { container.scale.setScalar([(Math.min(viewport.width * 0.04, 1))]) }} bottom position={[0, 7.4 - (0.65 / (viewport.width / viewport.height)), 0]} >
