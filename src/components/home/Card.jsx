...
{
    return (
        <div className="min-w-80 relative flex-1 p-[20px] rounded-xl bg-white/40 transition-all outline outline-2 outline-transparent outline-offset-0 hover:outline-primary hover:outline-offset-4">
