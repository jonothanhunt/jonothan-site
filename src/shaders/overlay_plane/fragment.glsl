...
void main()
{
    ...
    float strength = cnoise(vec3(displacedPosition.xy * vec2(6.0, scaledWorldposition.y * 10.0), displacedPosition.z + uTime * 0.4));
    ...
    vec3 top = mix(wavesMixed, vec3(1.0), clamp((vPosition.z * vPosition.z * 0.3) - 0.4, 0.0, 1.0));
